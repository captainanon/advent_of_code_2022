...
def solve_puzzle(file):
    ...
    for move in moves:
        num = move[0]
        boxes = stacks[move[1]-1][:num]
        stacks[move[2]-1] = boxes + stacks[move[2]-1]
        del stacks[move[1]-1][:num]      
    answer = ''
    for stack in stacks:
        answer += stack[0]
    return answer
...
if __name__ == '__main__':
    ...
    print(solve_puzzle(test_inputs)) # 'MCD'

    actual_inputs = 'puzzle_inputs.txt' 
    print(solve_puzzle(actual_inputs)) # 'JNRSCDWPP'